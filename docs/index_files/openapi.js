...
/*
     FILE ARCHIVED ON 5:53:19 дек 27, 2015 AND RETRIEVED FROM THE
 ...
 * /web/20151227055319/http://vk.com/
 */
...
if (!VK.xdConnectionCallbacks) {
  ...
  VK.extend(VK, {
    ...
    _userStatus: 'unknown',
    _domain: {
      main: '/web/20151227055319/https://oauth.vk.com/',
      api: '/web/20151227055319/https://api.vk.com/'
    },
    _path: {
      login: 'authorize',
  ...
  if (!VK.Auth) {
    VK.Auth = {
      ...
      revokeGrants: function(cb) {
        ...
        if (VK._session && VK._session.sid) {
          var url = '/web/20151227055319/https://login.vk.com/?act=openapi&oauth=1&aid=' + parseInt(VK._apiId, 10) + '&location=' + encodeURIComponent(window.location.hostname) + '&do_logout=1&token=' + VK._session.sid;
      ...
      getLoginStatus: function(cb, force) {
        ...
        var url = '/web/20151227055319/https://login.vk.com/?act=openapi&oauth=1&aid=' + parseInt(VK._apiId, 10) + '&location=' + encodeURIComponent(window.location.hostname);
        if (VK.Api.supportCORS()) {
